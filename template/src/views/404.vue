<template>
    ...
    <!--</div>-->
    <div>
        <py-button-group style="display: block; margin: 1% auto;width: 243px;">
            <py-button type="danger" suffix-icon="arrow-left" @click="returnLastPage" >返回上一页</py-button>
            <py-button type="danger" @click="returnFirstPage" >返回首页<i class="py-icon-arrow-right py-icon--right"></i></py-button>
        </py-button-group>
...
<style scoped>
    ...
    #upperTorso #rightArm {
        ...
        -ms-transform: rotate(0deg);
        transform: rotate(0deg);
        -webkit-transform-origin: 18% 1%;
        -ms-transform-origin: 18% 1%;
        transform-origin: 18% 1%;
